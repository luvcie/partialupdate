/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3bd5f41cdcec5ca9107f15ca9ac66b46)
...
interface __BaseEnv_Env {
	...
	BETTER_AUTH_URL?: "https://alpha.partialupdate.com" | "https://partialupdate.com";
	EMAIL_FROM: "noreply@partialupdate.com";
	EMAIL_FROM_NAME: "PartialUpdate";
	VERIFY_EMAIL: false;
	BETTER_AUTH_SECRET: string;
	PARTIAL_UPDATE: DurableObjectNamespace<import("./src/index").PartialUpdate>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PartialUpdate";
	}
	interface AlphaEnv {
		AUTH_DB: D1Database;
		EMAIL: SendEmail;
		AI: Ai;
		AUTH_PROVIDERS: ["GOOGLE","GITHUB","EMAIL_PASSWORD"];
		BETTER_AUTH_URL: "https://alpha.partialupdate.com";
		EMAIL_FROM: "noreply@partialupdate.com";
		EMAIL_FROM_NAME: "PartialUpdate";
		VERIFY_EMAIL: false;
		BETTER_AUTH_SECRET: string;
	...
	interface ProductionEnv {
		...
		AI: Ai;
		AUTH_PROVIDERS: ["GOOGLE","GITHUB","EMAIL_PASSWORD"];
		BETTER_AUTH_URL: "https://partialupdate.com";
		EMAIL_FROM: "noreply@partialupdate.com";
		EMAIL_FROM_NAME: "PartialUpdate";
		VERIFY_EMAIL: false;
		BETTER_AUTH_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_PROVIDERS" | "BETTER_AUTH_URL" | "EMAIL_FROM" | "EMAIL_FROM_NAME" | "VERIFY_EMAIL" | "BETTER_AUTH_SECRET">> {}
}
declare module "*.css" {
	const value: string;
