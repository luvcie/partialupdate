/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3ee0581c074e002cf46c92dd487d4527)
// Runtime types generated with workerd@1.20260526.1 2026-05-28 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	CLOUDFLARE_AI_GATEWAY_MODEL: "xai/grok-4.3";
	CLOUDFLARE_AI_GATEWAY_MODEL_SETTINGS: {"reasoning_effort":"high"};
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_AI_GATEWAY_MODEL" | "CLOUDFLARE_AI_GATEWAY_MODEL_SETTINGS">> {}
}
declare module "*.css" {
	const value: string;
