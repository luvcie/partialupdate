/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e0ffbae46dae8ce7caca89711288b989)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
declare module "*.css" {
	const value: string;
